...
<div class="topMenu">
  <div class="pW">
    <%
      String serverUrl = request.getScheme()+"://"+request.getHeader("Host")+"/";
        ...
        <c:when test="${user!=null}">
          <li class="login" id="login">
            <span  style="margin-right: 15px;">
                ${user.username},欢迎来到Vmall购物网！<a href="http://localhost:8087/user/logout" class=\"link-logout\">[退出]</a>
            </span>
          </li>
        </c:when>
        <c:otherwise>
          ...
          <span id="loginbar" style="margin-right: 15px;">
              <a href="http://localhost:8087/user/loginPage?serverUrl=${serverUrl}&redirectUrl=${serverUrl}">请登录</a>
          </span>
            <a href="https://passport.e3mall.cn/reg/?redirectUrl=http%3A//www.e3mall.cn/">免费注册</a>
          </li>
        </c:otherwise>
      </c:choose>
